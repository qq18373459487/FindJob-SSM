  ...
  <div class="row">
   ...
   <nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
     ...
     <li class="page-item"><a class="page-link" href="http://localhost:8080/com_hnist_war_exploded/work/GetAllWork?page=${page+1}">上一页</a></li>
     ...
     <li class="page-item"><a class="page-link" href="http://localhost:8080/com_hnist_war_exploded/work/GetAllWork?page=${page+1}">下一页</a></li>
