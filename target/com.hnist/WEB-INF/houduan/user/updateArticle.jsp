    ...
    <main class="main-cont content mCustomScrollbar">
        <div class="page-wrap">
            ...
            <div class="form-group-col-2">
                ...
                <div class="form-cont">
                    <input type="text"  class="form-control form-boxed" name="title" id="title" value="${article.getTitle()}">
                </div>
            </div>
            <div class="form-group-col-2">
                <div class="form-label">文章简介</div>
                <div class="form-cont">
                    <textarea class="form-control form-boxed" name="brief_introduction" id="brief_introduction" >${article.getBrief_introduction()}</textarea>
                </div>
            </div>
            ...
            <div class="form-group-col-2">
                ...
                <div class="form-cont">
                    <textarea class="form-control form-boxed"  name="author_text" id="author_text" onchange="autoTextarea()">${article.getAuthor_text()}</textarea>
                </div>
            </div>
            ...
            <div class="form-group-col-2">
                ...
                <div class="form-cont">
                    <input type="button" class="btn btn-primary" onclick="updateArticle(${article.getId()})" value="发布" />
                </div>
            </div>
            <!--开始::结束-->
        </div>
...
<script type="text/javascript">
    function updateArticle(id)
    {
        ...
        $.ajax(
            {
                url:'http://localhost:8080/com_hnist_war_exploded/user/updateArticle',
                data: {
                    title:title,
                ...
                success:function (data)
                {
                    if(data.code==="0")
                    {
                        ...
                        $("#msg").html("修改成功，将返回文章管理页面");
                        setTimeout(() =>window.location.href="http://localhost:8080/com_hnist_war_exploded/user/getArticle", 1800)
