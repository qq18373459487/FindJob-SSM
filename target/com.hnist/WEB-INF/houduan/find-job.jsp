			...
			<div class="row">
				...
				<div class="col-lg-3">
					<select class="category" name="WorkType" id="WorkType">
						...
						<option value="市场/传媒">市场/传媒</option>
						...
						<option value="采购/外贸">采购/外贸</option>
						<option value="电子/电气">电子/电气</option>
						<option value="质量/生产管理">质量/生产管理</option>
						<option value="法律/翻译">法律/翻译</option>
...
<div class="category-style-two pb-70">
	<div class="container">
		<div class="section-title">
			<h2 align="center">全部职位类别</h2>
			<p>要使整个人生都过得舒适、愉快，这是永远都不可能的，因为人类必须具备一种能应付逆境的态度。</p>
		</div>
		<div class="row">
			<div class="col-lg-3 col-sm-6">
				<a onclick="FindJobByWorkType('建设')">
			...
			<div class="col-lg-3 col-sm-6">
				<a onclick="FindJobByWorkType('金融')">
					<div class="category-item">
			...
			<div class="col-lg-3 col-sm-6">
				<a onclick="FindJobByWorkType('医疗')">
					<div class="category-item">
			...
			<div class="col-lg-3 col-sm-6">
				<a onclick="FindJobByWorkType('设计')">
					<div class="category-item">
			...
			<div class="col-lg-3 col-sm-6">
				<a onclick="FindJobByWorkType('银行')">
					<div class="category-item">
			...
			<div class="col-lg-3 col-sm-6">
				<a onclick="FindJobByWorkType('汽车')">
					<div class="category-item">
			...
			<div class="col-lg-3 col-sm-6">
				<a onclick="FindJobByWorkType('教育')">
					<div class="category-item">
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('互联网')">
					<div class="category-item">
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('市场/传媒')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>市场/传媒</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('销售')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>销售</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('人力行政')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>人力行政</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('物流/仓储/运输')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>物流/仓储/运输</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('技工/普工')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>技工/普工</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('酒店/餐饮/旅游')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>酒店/餐饮/旅游</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('采购/外贸')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>采购/外贸</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('电子/电气')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>电子/电气</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('质量/生产管理')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>质量/生产管理</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('法律/翻译')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>法律/翻译</h3>
						<br/>
			...
			<div class="col-lg-3  col-sm-6">
				<a onclick="FindJobByWorkType('化学化工')">
					<div class="category-item">
						<i class="flaticon-computer"></i>
						<h3>化学化工</h3>
						<br/>
...
<script TYPE="application/javascript">
	function FindJobByWorkType(WorkType)
	{
		window.location.href="http://localhost:8080/com_hnist_war_exploded/work/SelectWorkByWorkType?WorkType="+WorkType;
	}
