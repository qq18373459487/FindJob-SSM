...
public interface WorkService
{
    ...
    String SelectWorkByWorkType(String type,Model model,HttpSession session,String page);

    List<WorkList> queryWorkListPageByWorkType(int page,String WorkType);
    // 查询页数
    int queryPageByWorkType(String WorkType);
