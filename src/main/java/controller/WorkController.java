...
public class WorkController {
    ...
    //在这里进行工作类型的查找
    @RequestMapping("/SelectWorkByWorkType")
    public String SelectWorkByWorkType(String WorkType,Model model,HttpSession session,String page)
    {
       return workService.SelectWorkByWorkType(WorkType,model,session,page);
    }
    ...
    public void download(@RequestParam(value="filename")String filename,
        ...
        out.close();
        workMapper.updateCvByFile_Url(path);
    }
