...
<c:forEach items="${list}" var="company">
					...
					<tr class="cen">
						...
						<td>
							...
							<a href="http://localhost:8080/com_hnist_war_exploded/company/check?name=审核通过&&id=${company.getId()}">通过</a>
							<a href="http://localhost:8080/com_hnist_war_exploded/company/check?name=审核不通过&&id=${company.getId()}">不通过</a>
						</td>
					</tr>
					</tbody>
