            ...
            <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-3">
                ...
                <div class="signup-form">
                    ...
                    <div class="signup-btn   text-center">
                        <button type="submit" id="register_btn" onclick="register()">提交</button>
                    </div>
...
<script type="text/javascript">
    ...
    function register()
    {
       ...
       if(com_pwd==null)
        ...
        $.ajax(
            {
                url:'http://localhost:8080/com_hnist_war_exploded/findPassword',
                data: {
                    com_pwd:com_pwd,
                    email:email,
                    code:code
    ...
    function getCode()
    {
        var email=$.trim($("#email").val());
        $.ajax({
            url:'http://localhost:8080/com_hnist_war_exploded/VerificationCode',
            type: "post",
            data:{"email":email},
            dataType:"json",
            success: function (re)
            {
                ...
                }else
                {
                    if (re.code==="1") {
                        ...
                        document.getElementById("message_password").innerText="邮箱不存在";
                    }
                    if(re.code==="2")
                    {
